...
func main() {
	...
	o.Tx("adminAddNFTCatalogDirect",
		...
		WithArg("publicLinkedTypeRestrictions", []string{"A.34f2bf4a80bb0f69.GooberXContract.GooberCollectionPublic", "A.1d7e57aa55817448.NonFungibleToken.Receiver", "A.1d7e57aa55817448.NonFungibleToken.CollectionPublic", "A.1d7e57aa55817448.ViewResolver.ResolverCollection"}),
		WithArg("publicLinkedTypeIdentifier", "A.34f2bf4a80bb0f69.GooberXContract.Collection"),
		WithArg("privateLinkedTypeRestrictions", []string{"A.1d7e57aa55817448.NonFungibleToken.Provider", "A.34f2bf4a80bb0f69.GooberXContract.GooberCollectionPublic", "A.1d7e57aa55817448.NonFungibleToken.Receiver", "A.1d7e57aa55817448.NonFungibleToken.CollectionPublic", "A.1d7e57aa55817448.ViewResolver.ResolverCollection"}),
	...
	o.Tx("adminAddNFTCatalogDirect",
		...
		WithArg("publicLinkedTypeRestrictions", []string{"A.34f2bf4a80bb0f69.PartyMansionDrinksContract.DrinkCollectionPublic", "A.1d7e57aa55817448.NonFungibleToken.Receiver", "A.1d7e57aa55817448.NonFungibleToken.CollectionPublic", "A.1d7e57aa55817448.ViewResolver.ResolverCollection"}),
		WithArg("publicLinkedTypeIdentifier", "A.34f2bf4a80bb0f69.PartyMansionDrinksContract.Collection"),
		WithArg("privateLinkedTypeRestrictions", []string{"A.1d7e57aa55817448.NonFungibleToken.Provider", "A.34f2bf4a80bb0f69.PartyMansionDrinksContract.DrinkCollectionPublic", "A.1d7e57aa55817448.NonFungibleToken.Receiver", "A.1d7e57aa55817448.NonFungibleToken.CollectionPublic", "A.1d7e57aa55817448.ViewResolver.ResolverCollection"}),
