...
access(all) contract FindRulesCache {
    ...
    access(all) fun getTenantFindRules(tenant: String, ruleId: String) : ActionResult? {
        if self.tenantFindRules[tenant] == nil {
            return nil
        }
    ...
    access(all) fun getTenantTenantRules(tenant: String, ruleId: String) : ActionResult? {
        if self.tenantTenantRules[tenant] == nil {
            return nil
        }
    ...
    access(all) fun getTenantCut(tenant: String, ruleId: String) : TenantCuts? {
        if self.tenantCuts[tenant] == nil {
            return nil
        }
