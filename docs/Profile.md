...
### fun `findWalletCapability()`

```cadence
func findWalletCapability(_ Address): Capability<&{FungibleToken.Receiver}>
```
...
```cadence
func createUser(name String, createdAt String): Profile.User
```
