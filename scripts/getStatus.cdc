...
pub fun main(user: String) : Report {
	...
	if let address=FIND.resolve(user) {
		...
		let items : {String : FindMarket.SaleItemCollectionReport} = FindMarketOptions.getFindSaleItemReport(address: address, getNFTInfo: true)

		let marketBids : {String : FindMarket.BidItemCollectionReport} = FindMarketOptions.getFindBidsReport(address: address, getNFTInfo: true)
