//this is a copy of getNFTId right now
	...
	for key in ids.keys {
		for id in ids[key]! {
			...
			switch key {
				...
				case "PartyBeers": d  = getPartyBeers(owner:owner, id:id) 
				...
				case "MotoGP": d  = getMotoGP(owner:owner, id:id)
				...
				case "MatrixWorldAssets": d  = getMatrixWorldAssets(owner:owner, id:id) 
				...
				case "Geniace": d  = getGeniace(owner:owner, id:id) 
...
pub fun	getNeoA(owner:PublicAccount, id:UInt64) : MetadataCollectionItem? {
	return getItemForMetadataStandard(path: NeoAvatar.CollectionPublicPath, owner: owner, externalFixedUrl: "", id:id)
}
