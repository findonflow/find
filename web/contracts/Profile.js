...
/**
* Method to generate cadence code for Profile transaction
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const ProfileTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `Profile =>`)
...
/**
* Deploys Profile transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployProfile = async (props) => {
  const { addressMap = {} } = props;
  const code = await ProfileTemplate(addressMap);
  const name = "Profile"
